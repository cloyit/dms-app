...
public class text_zxing{

    public static void main(String[] args) {
        try {
            QREncode();

            QRReader(new File("D:\\zxing.jpeg"));
    ...
    public static void QREncode() throws WriterException, IOException {
        String content = "https://blog.csdn.net/qq_45862617?spm=1010.2135.3001.5343/";//二维码内容
        int width = 200; // 图像宽度
        int height = 200; // 图像高度
        ...
        MatrixToImageWriter.writeToPath(bitMatrix, format, new File("D:\\zxing.jpeg").toPath());// 输出原图片
         ...
         */
        BufferedImage bufferedImage = LogoMatrix(MatrixToImageWriter.toBufferedImage(bitMatrix,matrixToImageConfig), new File("D:\\log.jpeg"));
//        BufferedImage bufferedImage = LogoMatrix(toBufferedImage(bitMatrix), new File("D:\\logo.png"));
        ImageIO.write(bufferedImage, "jpeg", new File("D:\\zxing.jpeg"));//输出带logo图片
